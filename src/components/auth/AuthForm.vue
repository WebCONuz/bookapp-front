...
<template>
  <div class="py-6 sm:p-8 rounded-lg box-shadow">
    <div
      class="title py-3 sm:py-2 px-4 bg-blue-100 flex items-center mb-4 rounded-lg"
    >
      <i
        class="bx bx-lock-open-alt text-[32px] sm:text-[40px] text-gray-600 mr-2 sm:mr-3"
      ></i>
      <div class="text-gray-600">
        <h1 class="text-lg sm::text-xl font-semibold sm:mb-1">
          {{ isLogin ? "Tizimga kirish" : "Ro'yxatdan o'tish" }}
        </h1>
        <p class="text-xs sm:text-sm">
          Marxamat qilib ma'lumotlarni to'ldiring.
        </p>
      </div>
    </div>
    <Form
    ...
    >
      ...
      <div class="form-item mb-3">
        <label class="text-sm text-gray-700 font-semibold">Login</label>
        <Field
          name="userEmail"
          type="text"
          class="my-1 outline-none border border-gray-400 ring-0 rounded px-4 py-2 block w-full"
