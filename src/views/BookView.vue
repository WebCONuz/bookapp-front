    ...
    <div class="container mb-20">
      <div class="flex items-center px-[10px]">
        ...
        <img
          ...
          alt="wrapper-image"
          class="w-[40%] rounded-md bg-gray-300"
        />
        <!-- 2 -->
        <div class="w-[60%] pl-12">
          <!-- title -->
          <h1 class="text-3xl text-[#701BF8] font-semibold uppercase mb-2">
            Dunyoning ishlari
          </h1>

          <!-- raiting -->
          <p class="flex">
            <span class="text-lg mr-4 text-[#701BF8]">O'tkir Hoshimov</span>
